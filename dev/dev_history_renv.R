...
# Install from CRAN ----
install.packages("rstudioapi", repos = getOption("repos")["RSPM"])
install.packages("remotes", repos = getOption("repos")["RSPM"])
remotes::install_cran("devtools", repos = getOption("repos")["RSPM"])
remotes::install_cran("BH", repos = getOption("repos")["RSPM"])
